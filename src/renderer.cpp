...
Renderer::Renderer()
{
  ...
  sdl_window = SDL_CreateWindow("Snake Game", SDL_WINDOWPOS_CENTERED,
                                SDL_WINDOWPOS_CENTERED, constants::kScreenWidth,
                                constants::kScreenHeight, SDL_WINDOW_SHOWN);
  ...
  // Set width and height of block render object only once (doesn't change within the game)
